...
class Agent():
    ...
    def __init__(self, task):
        ...
        # Score tracker and learning parameters - this was added
    ...
    def reset_episode(self):
        self.noise.reset(mu=np.random.randint(-100,100)+0.0)
        self.total_reward = 0.0 # this was added
    ...
    def step(self, action, reward, next_state, done):
        ...
        self.total_reward += reward # this was added
